...
//                        new CreateQueueRequest("MyQueue");
                ...
                final String queueA = "https://sqs.us-west-2.amazonaws.com/025683585287/A";
                final String queueB = "https://sqs.us-west-2.amazonaws.com/025683585287/B";
                final String queueC = "https://sqs.us-west-2.amazonaws.com/025683585287/C";


//                final String myQueueUrl = "https://sqs.us-west-2.amazonaws.com/025683585287/A";
                ...
                sqs.sendMessage(new SendMessageRequest(queueA,
                        "This is my message text to A."));
                // Queue B
                System.out.println("Sending a message to MyQueue.\n");
                sqs.sendMessage(new SendMessageRequest(queueB,
                        "This is my message text to B."));

                // Queue C
                System.out.println("Sending a message to MyQueue.\n");
                sqs.sendMessage(new SendMessageRequest(queueC,
                        "This is my message text to C."));
